/**
 * Price service for domain registration/renewal costs
 * Uses a static price list for common TLDs
 * Note: In production, this should integrate with real registrar APIs
 */
